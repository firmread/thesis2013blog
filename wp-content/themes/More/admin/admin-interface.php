...
function optionsframework_add_admin() {
    ...
    $of_page = add_menu_page('More Plus Settings', 'More+ Options', 'edit_theme_options', 'optionsframework','optionsframework_options_page', get_template_directory_uri() . '/assets/img/moremenu.png'); // Default
