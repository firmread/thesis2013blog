		...
		//Styles
	     ...
	     if ($style != '') {
	          ...
	          if($GLOBALS['stylesheet'] != '')
	               echo '<link class="skin" href="'. OF_DIRECTORY .'/styles/'. $GLOBALS['stylesheet'] .'" rel="stylesheet" type="text/css" />'."\n";         
	          else
	               echo '<link href="'. OF_DIRECTORY .'/styles/red.css" rel="stylesheet" type="text/css" />'."\n";         		  
	     }       
